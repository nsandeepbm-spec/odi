...
export default function IndustriesPage() {
  return (
    <div className="min-h-screen bg-[#0D1B2A] text-white pt-24 md:pt-32 pb-24 mt-16">
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-black mb-6 tracking-tighter text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {industries.map((industry, index) => (
            <motion.div
              ...
              className="group flex flex-col p-8 rounded-[1.5rem] bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-[#06B6D4]/30 transition-all duration-300 shadow-lg"
            >
              <div className="mb-6">
        ...
        {/* CTA Section - Matches Bottom of Image */}
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
          className="mt-24 p-8 md:p-12 rounded-[2rem] bg-gradient-to-b from-white/[0.05] to-transparent border border-white/5 text-center max-w-4xl mx-auto"
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-4 tracking-tight">DON'T SEE YOUR INDUSTRY?</h2>
          ...
          <Link 
            to="/contact"
            className="inline-flex items-center gap-3 px-8 py-4 bg-white/[0.05] hover:bg-white/[0.1] border border-white/10 hover:border-[#06B6D4]/50 rounded-full font-bold transition-all duration-300 group"
          >
