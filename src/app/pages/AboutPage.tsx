...
const ODIBadge = ({ className = "" }: { className?: string }) => (
  <div className={`inline-flex items-center px-4 py-1.5 rounded-lg border border-cyan-500/30 bg-cyan-950/20 backdrop-blur-sm shadow-[0_0_20px_rgba(6,182,212,0.1)] ${className}`}>
    <span className="text-cyan-400 font-bold text-xs tracking-[0.2em]">ODI™</span>
  </div>
);
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-white/60 text-lg leading-relaxed">
                <p>
                  The mission of <span className="text-white font-bold">ODI™</span> is to restore the natural dimension that traditional flat screens have stripped away from visual storytelling.
                </p>
                <p>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-white/60 text-lg leading-relaxed">
                ...
                <p>
                  As devices like Apple Vision Pro and glass-free 3D displays redefine human interaction, ODI™ is engineering content for a future where visuals are truly felt.
                </p>
              </div>
            </motion.div>
          </div>
