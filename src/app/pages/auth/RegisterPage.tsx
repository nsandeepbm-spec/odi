...
export default function RegisterPage() {
  ...
  return (
    <AuthShell
      ...
      accent="Starts Here."
      tagline="Create an account to book the Space Explorer, track deliveries and unlock the whole collection as it launches."
      points={['One account, every Explorer', 'Faster checkout each time', 'Collector updates before anyone']}
    >
      <div className="mb-8">
