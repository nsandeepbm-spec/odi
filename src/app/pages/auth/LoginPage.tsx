  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative" style={{ background: T.bgAlt, color: T.text }}>
      ...
      <motion.div 
        ...
        className="w-full max-w-md bg-white p-8 md:p-10 rounded-[2rem] shadow-xl border border-neutral-100"
      >
        <div className="text-center mb-10">
          <h1 className="text-3xl font-black tracking-tight mb-2">Welcome Back</h1>
          <p className="text-sm" style={{ color: T.sub }}>Enter your credentials to access your account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link to="#" className="text-xs font-medium text-indigo-500 hover:text-indigo-600">Forgot password?</Link>
            </div>
            <input 
              type="password" 
              required
