...
/** Official Instagram brand mark with unique gradient id per instance. */
...
export const ODI_WHATSAPP_URL = 'https://wa.me/919876907266';
...
/** Shared ODI social profiles — used by Footer + Contact. */
export const odiSocialLinks: SocialLink[] = [
  {
    label: 'Instagram',
